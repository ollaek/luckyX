...
const GoogleButton = (history: any, setShow: any) => {
  ...
  return (
    <GoogleLogin
      clientId="482986878054-luvjm9k8e6nam51ktai0sn670lon8c0i.apps.googleusercontent.com"
      buttonText="Login"
